        ...
        <div>
            <nav className='nav1'>
                <ul>
                    ...
                    <div className="elem">
                        <Link to={"/Internship"}>
                       <p id='int' className='' onMouseEnter={showInternShips}>Internships<i onClick={hideInternShips} id='ico' className="bi bi-caret-down-fill"></i></p></Link>
                    ...
                    <div className="auth">
                        ...
                        <button className='btn2'><Link to={"/register"}>
                            Register</Link> 
                        </button>
                    </div>
                    </>)
